        ...
        <div className="container-custom relative z-10">
          ...
          <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-6 sm:p-8 md:p-10 max-w-4xl">
            <div className="prose prose-sm max-w-none
                          ...
                          prose-h2:text-lg prose-h2:font-semibold prose-h2:mt-8 prose-h2:mb-3 prose-h2:first:mt-0
                          ...
                          prose-ul:text-muted-foreground prose-ul:my-3 prose-ul:ml-4 prose-ul:list-disc
                          prose-ol:text-muted-foreground prose-ol:my-3 prose-ol:ml-4 prose-ol:list-decimal
                          prose-li:mb-1
